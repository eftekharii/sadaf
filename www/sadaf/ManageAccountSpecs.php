            ...
            <td>
                <table width="100%" border="0">
                    ...
                    <tr>
                        ...
                        <td nowrap>
                            <input type="password" name="Item_UserPassword" id="Item_UserPassword" maxlength="100"
                                   size="40">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td nowrap>
                            <select name="Item_PersonID" id="Item_PersonID">
                                <option value=0>-
                                    <? echo SharedClass::CreateAdvanceRelatedTableSelectOptions("sadaf.persons", "PersonID", "FullName", "concat(plname, ' ', pfname) as FullName, PersonID", "plname, pfname"); ?>
                            </select>
                        </td>
                    </tr>
                    <tr>
